...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        # Слоты для кнопок получения данных
        ...
        # Слоты для изменения значения в элементах управления
    ...
    def onComboBoxTextChanged(self, text: str) -> None:
        """
    ...
    def onDateTimeEditDateTimeChanged(self, dateTime: QtCore.QDateTime) -> None:
        """
